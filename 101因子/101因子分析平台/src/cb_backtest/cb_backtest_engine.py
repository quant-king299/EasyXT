    ...
    def run_backtest(
        ...
        **strategy_kwargs
        ...
        Args:
            ...
            max_price: 最高价格过滤
            min_volume: 最低成交量过滤
            df: 可选，外部传入的 DataFrame（用于 ETF/股票回测）
            code_col: 代码列名
            date_col: 日期列名
            price_col: 价格列名
            vol_col: 成交量列名
        ...
        if df is None:
            ...
            # 统一列名
            df = df.rename(columns={code_col: 'ts_code', date_col: 'trade_date',
