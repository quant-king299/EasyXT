...
class QMTSource(BaseDataSource):
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            logger.info("[QMTSource] 连接成功")
            return True

        except ImportError:
            logger.info("[QMTSource] xtquant模块未安装")
            return False
        except Exception as e:
            logger.info(f"[QMTSource] 连接失败: {e}")
            self.is_connected = False
            return False
    ...
    def get_price(self,
        ...
        try:
            ...
            if not validate_date(start_date) or not validate_date(end_date):
                logger.info(f"[QMTSource] 日期格式错误: {start_date} - {end_date}")
                return None
            ...
            logger.info(f"[QMTSource] 获取价格数据失败 ({symbol}): {e}")
            return None
    ...
    def get_fundamentals(self,
        ...
        try:
            ...
            if not validate_date(date):
                logger.info(f"[QMTSource] 日期格式错误: {date}")
                return None
            ...
            for symbol in symbols:
                try:
                    ...
                    logger.info(f"[QMTSource] 获取{symbol}基本面数据失败: {e}")
                    continue
            ...
            logger.info(f"[QMTSource] 获取基本面数据失败: {e}")
            return None
    ...
    def _get_close_price(self, symbol: str, date: str, max_days_back: int = 10) -> Optional[float]:
        ...
        try:
            ...
            logger.info(f"[QMTSource] 获取{symbol} {date}收盘价失败: {e}")
            return None
    ...
    def get_trading_dates(self,
        ...
        try:
            ...
            logger.info("[QMTSource] QMT可能不提供交易日历接口")
            return None

        except Exception as e:
            logger.info(f"[QMTSource] 获取交易日历失败: {e}")
            return None
    ...
    def get_stock_list(self, market: str = 'stock') -> Optional[List[str]]:
        ...
        try:
            ...
            logger.info(f"[QMTSource] 获取股票列表失败: {e}")
            return None
    ...
    def get_instrument_info(self, symbol: str) -> Optional[Dict]:
        ...
        try:
            ...
            logger.info(f"[QMTSource] 获取证券信息失败: {e}")
            return None
