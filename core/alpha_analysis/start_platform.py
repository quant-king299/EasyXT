...
def load_data_example():
    ...
    logger.info(f"[OK] 数据生成完成：{len(dates)}个交易日，{len(stocks)}只股票，{len(factor_dict)}个因子\n")
