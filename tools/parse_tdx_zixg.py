...
def read_tdx_zixg():
    ...
    logger.info(f"[步骤1] 定位自选股文件")
    logger.info("-"*70)
    logger.info(f"  通达信路径: {tdx_path}")
    logger.info(f"  自选股文件: {zxg_file}")
    ...
    logger.info(f"  [OK] 文件存在\n")


    # 方法1: 尝试二进制解析

    logger.info("[方法1] 二进制解析")
    logger.info("-"*70)
