...
from strategy_logic import 多因子优选策略Strategy
from order_manager import OrderManager
from risk_control import RiskController


class 多因子优选策略StrategyLive:
    """
    基于市值、ROE、动量的多因子选股策略 实盘交易版
    """
    ...
    def initialize(self):
        """初始化"""
        logger.info(f"初始化多因子优选策略实盘策略...")

        # TODO: 连接QMT
        # self.trader = XtQuantTrader(self.account_id)

        # 初始化策略
        self.strategy = 多因子优选策略Strategy(None)
...
def main():
    """主函数"""
    # 创建策略实例
    strategy_live = 多因子优选策略StrategyLive()
