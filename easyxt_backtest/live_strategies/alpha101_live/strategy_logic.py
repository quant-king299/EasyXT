...
class Alpha101多因子策略Strategy:
    """
    使用Alpha101因子的多因子选股策略
    ...
    def __init__(self, data_manager):
        ...
        self.name = "Alpha101多因子策略"
        self.current_portfolio = {}

        # 配置
        self.universe_config = {'type': 'index', 'index_code': '000852.SH'}
        self.portfolio_config = {'select_method': 'top_n', 'top_n': 20, 'weight_method': 'equal', 'risk_control': {'max_position_count': 30, 'max_single_weight': 0.1, 'min_single_weight': 0.02}}
